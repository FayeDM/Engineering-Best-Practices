...
The above example references Stylelint being placed in a subfolder of tools. It is highly suggested that you migrate your stylelint to there. However, by changing the path to your project/theme root, you should be able to reference its existing location. 
...
1. The `vendor` script might show an error in your production environment.
